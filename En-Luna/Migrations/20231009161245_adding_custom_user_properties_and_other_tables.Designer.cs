...
namespace En_Luna.Migrations
{
    ...
    [Migration("20231009161245_adding_custom_user_properties_and_other_tables")]
    partial class adding_custom_user_properties_and_other_tables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("En_Luna.Data.Models.Review", b =>
                {
                    ...
                    b.Property<string>("ContractorUserId1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("SolicitorUserId1")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("ContractorUserId1");

                    b.HasIndex("SolicitationRoleId");

                    b.HasIndex("SolicitorUserId1");
            ...
            modelBuilder.Entity("En_Luna.Data.Models.Address", b =>
                {
                    b.HasOne("En_Luna.Data.Models.State", "State")
                        .WithOne()
                        .HasForeignKey("En_Luna.Data.Models.Address", "StateId")
            ...
            modelBuilder.Entity("En_Luna.Data.Models.Document", b =>
                {
                    b.HasOne("En_Luna.Data.Models.User", "Account")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("En_Luna.Data.Models.Focus", b =>
                {
                    b.HasOne("En_Luna.Data.Models.Discipline", "Discipline")
                        .WithOne("Focus")
                        .HasForeignKey("En_Luna.Data.Models.Focus", "DisciplineId")
            ...
            modelBuilder.Entity("En_Luna.Data.Models.Review", b =>
                {
                    b.HasOne("En_Luna.Data.Models.User", "ContractorUser")
                        ...
                        .HasForeignKey("ContractorUserId1")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.HasOne("En_Luna.Data.Models.User", "SolicitorUser")
                        ...
                        .HasForeignKey("SolicitorUserId1")
                        .OnDelete(DeleteBehavior.NoAction);
